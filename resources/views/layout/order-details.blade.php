            ...
            <div class="col-md-6 col-sm-6 col-xs-12 ">
                ...
                <form action="/action_page.php ">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" id="usr" name="username" value="Description" disabled>
                        <label for="usr">Price:</label>
                        <input type="text" class="form-control" id="usr" name="username" value="15,000" disabled>
