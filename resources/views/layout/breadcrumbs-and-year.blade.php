<div class="d-flex align-items-center justify-between p-4">
    ...
    <a href="/user/set-ppmp-year" class="text-sm sm:text-xl md:text-2xl font-bold text-blue-600 bg-yellow-600 text-white py-1 px-4 rounded-3xl  hover:bg-yellow-800 hover:no-underline">Year: 2021</a> 
    @else
